...
favoriteThings.car = 'Tesla Roadster'
favoriteThings.show = 'Lucifer'
...
const {utah, california, texas, arizona} = obj
  ...
  return `The total population of Utah, California, Texas and Arizona is ${utah + california + texas + arizona}`
}
...
function ingredients(obj){
  ...
  return `You will need ${carbs, fat, protein} for your ingredients`
